...
const PreviewImage = ({ imageUrl, title }: { imageUrl?: string; title: string }) => {
  if (!imageUrl) {
    return (
      <div className="aspect-video bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center text-white">
        <EventImageIcon />
      </div>
    )
  }
      ...
      <Image
        ...
        onError={(e) => {
          ...
          if (parent) {
            ...
            fallback.className = `bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center text-white w-full h-full`
